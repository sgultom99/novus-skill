...
- No product-line enumerations, project counts, or session-history provenance.
...
maintainer's private Claude memory (the naming-rule note), NOT in this repo — putting
the list here would republish the very names it bans. Maintainer sessions load it
